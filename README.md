...
| `+` | `+` |
| [debian-iso-builder-import-pacstall-kde-plasma-attach-themes](https://samwhelp.github.io/debian-iso-builder-import-pacstall-kde-plasma-attach-themes/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-import-pacstall-kde-plasma-attach-themes) |
| `=` | `=` |
| [debian-iso-builder-include-pacstall-kde-plasma-attach-themes](https://samwhelp.github.io/debian-iso-builder-include-pacstall-kde-plasma-attach-themes/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-include-pacstall-kde-plasma-attach-themes) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-include-pacstall-kde-plasma-attach-themes/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-include-pacstall-kde-plasma-attach-themes/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-include-pacstall-kde-plasma-attach-themes/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-include-pacstall-kde-plasma-attach-themes](https://github.com/samwhelp/debian-iso-builder-include-pacstall-kde-plasma-attach-themes)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-include-pacstall-kde-plasma-attach-themes.git
```


> change dir to `debian-iso-builder-include-pacstall-kde-plasma-attach-themes`

``` sh
cd debian-iso-builder-include-pacstall-kde-plasma-attach-themes
```
...
> The resulting ISO file will be placed on `debian-iso-builder-include-pacstall-kde-plasma-attach-themes/dist`
